...
import 'package:resnet_liz/design/Design.dart';
...
class _ResnetScreenState extends State<ResnetScreen> {
  ...
  final url = Uri.parse("https://resnet-service-lixbeth34.cloud.okteto.net/v1/models/resnet:predict");
      ...
      child: Scaffold(
        ...
        floatingActionButton:  Visibility(
          ...
          child: FloatingActionButton(
            ...
            foregroundColor: Color.fromARGB(255, 128, 34, 172),
            onPressed: () {
              uploadImage();
            },
          ),
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text('Cámara'),
                        style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 2, 255, 44)),
                            padding:
